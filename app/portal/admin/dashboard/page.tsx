      ...
      {(metrics.pendingUsers > 0 || metrics.newFormSubmissions > 0 || metrics.submittedMissions > 0) && (
        <SectionCard title="Items Requiring Attention" icon="shield" bodyClassName="grid gap-3 sm:grid-cols-3">
          ...
          {metrics.newFormSubmissions > 0 && (
            <Link href="/portal/admin/form-submissions" className="flex items-center gap-3 rounded-lg border border-sky-200 bg-sky-50 px-4 py-3 transition-colors hover:border-sky-300">
          ...
          {metrics.submittedMissions > 0 && (
            <Link href="/portal/admin/trips" className="flex items-center gap-3 rounded-lg border border-primary/20 bg-blue-50 px-4 py-3 transition-colors hover:border-primary/40">
