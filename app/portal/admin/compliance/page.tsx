...
async function complianceCounts() {
  try {
    ...
    const [privacyRequests, consentEvents, marketingConsents, auditEvents] = await Promise.all([
    ...
    return { ok: true as const, privacyRequests, consentEvents, marketingConsents, auditEvents };
  } catch (error) {
