  ...
  return (
    <PortalShell role="admin" user={user}>
      ...
      <Tabs defaultValue="overview" className="gap-5">
        <TabsList className="h-auto w-full flex-wrap justify-start bg-[#050B14]/70 p-1">
            ...
            {communications.length ? (
              <div className="grid gap-3">
                {communications.map((message) => (
                  <details key={message.id} className="rounded-lg border border-white/10 bg-white/[0.04] p-4">
                    ...
                    <div className="mt-4 border-t border-white/10 pt-4">
                      ...
                      />
                      <pre className="mt-4 whitespace-pre-wrap rounded-md border border-white/10 bg-[#050B14]/80 p-3 text-xs leading-5 text-slate-200">{message.body}</pre>
                    </div>
                  </details>
                ))}
              </div>
