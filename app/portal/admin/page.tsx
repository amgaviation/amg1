...
export default function AdminPortalPage() {
  return (
    <PortalDashboard
      ...
      description="Admins oversee access requests, user roles, aircraft records, settings, documents, crew assignments, and mission activity."
      image="/images/jet-sky.png"
      metrics={[
        { label: "Access requests", value: "05" },
        { label: "Active users", value: "48" },
        { label: "Open missions", value: "11" },
      ...
      panels={[
        ...
        { title: "Mission Oversight", body: "Monitor lifecycle status from submitted to crew review, scheduled, completed, or cancelled.", icon: "calendar" },
