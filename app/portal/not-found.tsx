      ...
      <div className="mx-auto flex min-h-[70vh] w-full max-w-6xl items-center justify-center">
        <section className="deck-card w-full max-w-xl p-6">
          <div className="flex items-start gap-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[var(--deck-line-strong)] bg-[#F8FAFB]">
          ...
          <div className="mt-6">
            <Link
              href="/portal"
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-[var(--deck-line-strong)] bg-white px-5 text-sm font-semibold text-[var(--deck-text-2)] transition-colors hover:border-[var(--deck-gold-line)] hover:bg-[var(--deck-gold-tint)]"
            >
