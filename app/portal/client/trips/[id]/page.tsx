...
export default async function ClientTripDetailPage({
  ...
  return (
    <>
      ...
      ) : sp.error === "cancel-requires-ops" ? (
        <Notice tone="warn">
          Crew are already committed to this mission, so cancellation goes through AMG Operations —
          send us a message and we&apos;ll stand it down with the crew directly.
        </Notice>
      ) : sp.error === "failed" ? (
