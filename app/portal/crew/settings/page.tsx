    ...
    <PortalShell role="crew" user={user}>
      ...
      <SectionCard title="Crew Profile" icon="settings">
        <form action={saveCrewProfile} className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-3 rounded-lg border border-border bg-slate-50/80 p-4">
              ...
              {["monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"].map((day) => {
                ...
                return (
                  <div key={day} className="rounded-lg border border-border bg-white p-3">
                    <p className="text-xs font-bold uppercase tracking-wider text-primary">{day}</p>
