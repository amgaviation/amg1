...
export default function AccessDeniedPage() {
  return (
    ...
    >
      <Link href="/portal" className="inline-flex min-h-12 items-center rounded-full bg-primary px-6 py-3 font-display text-xs font-semibold uppercase tracking-widest text-primary-foreground" data-cursor="ENTER">
        Go to my portal
      </Link>
    </PortalAccessShell>
  );
