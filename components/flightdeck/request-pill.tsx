  ...
  return (
    ...
    >
      <Link
        ...
        prefetch={false}
        className="group flex items-center gap-2 rounded-full bg-instrument py-2 pl-6 pr-2 text-canvas shadow-[0_0_40px_rgba(0,232,135,0.35)] transition-shadow hover:shadow-[0_0_60px_rgba(0,232,135,0.55)]"
      >
