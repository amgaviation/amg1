...
export function AircraftSectionNav({ items }: { items: NavItem[] }) {
  ...
  return (
    <nav aria-label="Aircraft categories" className="sticky top-[var(--public-header-height)] z-30 border-y border-[var(--oc-line)] bg-[#0A1322]/85 shadow-[0_12px_30px_rgba(8,20,36,0.06)] backdrop-blur">
            ...
            <a
              ...
              className={cn(
                ...
                active === item.id
                  ...
                  : "border-[var(--oc-line)] text-[var(--oc-muted)] hover:border-accent hover:text-accent"
              )}
            >
              {item.label}
            </a>
