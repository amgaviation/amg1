  ...
  return (
    <section id="top" className="relative isolate flex min-h-[78svh] overflow-hidden border-b border-slate-950/20 pb-10 pt-28 text-white lg:items-end lg:pb-14 lg:pt-32">
      <div className="absolute inset-0 -z-10 bg-slate-950">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_26%,rgba(56,189,248,0.18),transparent_28rem)]" />
      </div>
      ...
      <div className="mx-auto grid w-full max-w-7xl items-end gap-10 px-6 lg:grid-cols-[minmax(0,1fr)_24rem] lg:px-10">
        <div className="max-w-5xl" data-scroll-animate>
          ...
          <h1 className="display-heading max-w-6xl text-balance text-5xl text-white sm:text-6xl lg:text-[5.2rem] 2xl:text-[7.2rem]">
            ...
            <span className="block text-sky-200">clearly coordinated.</span>
          </h1>
      ...
      <Link
        href="#capabilities"
        className="scroll-cue group absolute bottom-6 right-6 z-20 hidden items-center gap-4 rounded-full border border-white/18 bg-white/10 px-4 py-3 text-xs uppercase text-white backdrop-blur transition-colors hover:border-sky-300 hover:text-sky-200 md:flex"
