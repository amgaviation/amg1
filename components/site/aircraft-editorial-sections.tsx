            ...
            <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[0.96fr_1.04fr] lg:items-center lg:px-10 lg:py-28">
              ...
              <Reveal delay={0.12} className={cn("flex items-center", mediaLeft ? "lg:order-2 lg:pl-6" : "lg:order-1 lg:pr-6")} data-scroll-animate>
                <div>
                  ...
                  <div className="mt-8">
                    <Link href={`/contact?aircraft=${aircraft.id}`} className="inline-flex min-h-11 items-center gap-2 rounded-full bg-primary px-5 py-3 font-display text-xs font-semibold uppercase text-primary-foreground transition-colors hover:bg-primary/90">
