...
export function RecordSummaryHeader({
  ...
  return (
    <section className="rounded-lg border border-white/10 bg-[#07111F]/92 p-5 text-white shadow-[0_18px_58px_rgba(0,0,0,0.24)]">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <p className="eyebrow text-[0.64rem] text-primary">{eyebrow}</p>
          <h2 className="mt-2 break-words font-display text-3xl font-extrabold uppercase leading-none text-white sm:text-4xl">
            {title}
          </h2>
