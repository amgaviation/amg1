...
export const IMG = {
  ...
  serviceAircraftManagement: `${BASE}/service-aircraft-management-support.jpg`,
  serviceContractPilot: `${BASE}/service-contract-pilot-support.jpg`,
  serviceMaintenance: `${BASE}/service-maintenance-flight-support.jpg`,
  serviceFlightOps: `${BASE}/service-flight-operations-coordination.jpg`,
  serviceFleet: `${BASE}/service-fleet-support-program.jpg`,
