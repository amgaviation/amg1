...
// the CARTO basemap tiles used by the Live Crew Map
...
const contentSecurityPolicy = [
  ...
  "img-src 'self' data: blob: https://*.supabase.co https://*.basemaps.cartocdn.com https://www.googletagmanager.com https://*.google-analytics.com https://www.google-analytics.com https://www.facebook.com https://*.clarity.ms https://c.bing.com",
  "font-src 'self' data:",
